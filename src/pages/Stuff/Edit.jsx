                ...
                <div className="items-center m-5 pb-10 pt-10">
                    ...
                    <form onSubmit={handleEditStuff} class="max-w-sm mx-auto">
                        <div class="mb-5">
                            ...
                            <input type="text" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600
                            dark:placeholder-gray-400 dark:text-white dark:focus-ring-blue-500 dark:focus-border-blue-500" defaultValue={forms.name} placeholder="Ketik Nama Barang" required
                            onChange={e => setForms({...forms, name: e.target.value})}></input>
                        </div>
                        <div class="mb-5">
                            ...
                            dark border--gray 600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onChange={e => setForms({...forms, category: e.target.value})}>
